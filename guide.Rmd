...
>>>>>>> 0a3063e3a851142852c7606085aa5d9d80776f87
...
# To speed up this snapping a clipping operation could first be done to limit the number of 
# points to snap
...
While these metrics and rankings provide a good starting understanding of connectivity in the watershed there are many data which could serve to develop robust recommendations from this analysis. Recommendations for future development on this analysis are provided below in no particular order:
